/**
 * @api {post} /getFavoritePostByCustomer getFavoritePostByCustomer
 * @apiVersion 1.6.0
 * @apiName getFavoritePostByCustomer
 * @apiGroup Web-Post
 *
 * @apiDescription Get Favorite post list
 *
 * @apiParam {Number} [page]
 * @apiParam {Number} [limit]
 * @apiParam {String} [orderBy]     Order key
 * @apiParam {String} [order]       Order direction ['ascending', 'descending']
 * @apiParam {String} [status]      'PUBLISHED'
 *
 ...
 */
function getFavoritePostByCustomer() {}
...
/**
 * @api {post} /favoritePost favoritePost
 * @apiVersion 1.6.0
 * @apiName favoritePost
 * @apiGroup Favorite-Post
 *
 * @apiDescription customer favorite a post
...
/**
 * @api {post} /unfavoritePost unfavoritePost
 * @apiVersion 1.6.0
 * @apiName unfavoritePost
 * @apiGroup Favorite-Post
 *
 * @apiDescription customer can unfavorite a post
 * @apiPermission Required Login as Customer
 *
 * @apiParam {String} postId
 *
