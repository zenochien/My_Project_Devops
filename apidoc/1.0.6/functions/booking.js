...
/**
 * @api {post} /cancelBookingByStylist cancelBookingByStylist
 * @apiVersion 1.0.6
 * @apiName cancelBookingByStylist
 * @apiGroup Web-Booking
 ...
 * @apiUse LoginRequiredError
 */
function cancelBookingByStylist() {}

/**
 * @api {post} /cancelBookingByJob cancelBookingByJob
 * @apiVersion 1.0.6
 * @apiName cancelBookingByJob
 * @apiGroup Web-Booking
 ...
 * @apiExample {json} Request example
 * {
 *   "secretKey": "dsadas-fjasoifjas-dfjaisof",
 *   "bookingId": "gJQu5XT931",
 * }
 *
 * @apiSuccess {Object}  result
