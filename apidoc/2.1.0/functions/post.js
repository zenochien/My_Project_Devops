/**
 * @api {post} /getHashtagsByCustomer getHashtagsByCustomer
 * @apiVersion 2.1.0
 * @apiName getHashtagsByCustomer
 * @apiGroup Web-Post
 *
 * @apiDescription Change get list hashtag
 *
 ...
 * @apiSuccess {Number}  result.list.count
 * @apiSuccess {String}  result.list.tag
 *
 ...
 */
function getHashtagsByCustomer() {}

/**
 * @api {post} /getPostsByHashtag getPostsByHashtag
 * @apiVersion 2.1.0
 * @apiName getPostsByHashtag
 * @apiGroup Web-Post
 *
 * @apiDescription Get post list filter by hashtag
 ...
 * @apiSuccess {Boolean} result.list.isFavorite
 ...
 * @apiParam {Array}  [tags]          Require when status = PUBLISHED
 * @apiParam {Array}  [faceShapes]    Accepted values: ['丸型', '卵型', '四角', '逆三角', 'ベース']
 * @apiParam {Array}  [menus]         ObjectIds of Menu. Min: 1 image, Require when status = PUBLISHED,
 * @apiParam {Array}  [products]      objectIds of Product
 * @apiParam {String} [description]
 * @apiParam {String} [status]        UNPUBLISHED or PUBLISHED
 * @apiParam {Array}  [images]        ObjectIds of Image. Min: 1, max: 3 images,Require when status = PUBLISHED,
 *
 * @apiExample {json} Request example
 * {
 *   "postId": "Ac9olnzPdB",
 ...
 * @apiParam {Array}  [menus]         ObjectIds of Menu. Min: 1 image, Require when status = PUBLISHED
 * @apiParam {Array}  [products]      Require when status = PUBLISHED
 * @apiParam {String} [description]
 * @apiParam {Array}  [images]        ObjectIds of Image. Min: 1, max: 3 images, Require when status = PUBLISHED
 *
 * @apiExample {json} Request example
