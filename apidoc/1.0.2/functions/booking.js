...
/**
 * @api {post} /createBooking createBooking
 * @apiVersion 1.0.0
 * @apiName createBooking
 * @apiGroup Web-Booking
 * @apiPermission Login Required as Customer
 *
 * @apiDescription Create new booking
 *
 * @apiParam {String} stylistId
 * @apiParam {Array}  menus             objectIds of Menu. Min: 1, max: 10
 * @apiParam {String} serviceDateTime   Regex /^\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:00.000([+-][0-2]\d:[0-5]\d|Z)$/
 * @apiParam {String} cardId
 *
 * @apiExample {json} Request example
 * {
 *   "stylistId": "yEbDRqhRb0",
 *   "serviceDateTime": "2025-10-21T18:35:00.000Z",
 *   "cardId": "123456",
 *   "menus": ["iEFYxURrGy", "ET4wBn39Dk"]
 * }
 *
 * @apiSuccess {Object}  result
 * @apiSuccess {Array}   result.menus
 ...
 * - Salon operator can only see salon's bookings
 *
 * @apiParam {Array}  [bookingStatuses]    Accepted values: ['REQUESTED', 'CONFIRMED', 'CANCELED_OPERATOR','CANCELED_STYLIST', 'CANCELED_CUSTOMER', 'CANCELED_WITH_FEE', 'COMPLETED', 'NOT_ARRIVED']
 ...
 * @apiExample {json} Request example
 * {
 *   "bookingStatuses": ['CANCELED_OPERATOR', 'CANCELED_CUSTOMER', 'CANCELED_WITH_FEE'],
...
/**
 * @api {post} /getBookingStats getBookingStats
 * @apiVersion 0.5.0
 * @apiName getBookingStats
 * @apiGroup Web-Booking
 * @apiPermission Login Required as Salon Operator
 *
 * @apiDescription Get Booking statistics
 *
 * @apiSuccess {Object}  result
 * @apiSuccess {Number}  result.requestedCount
 * @apiSuccess {Number}  result.confirmedCount
 * @apiSuccess {Number}  result.completedCount
 * @apiSuccess {Number}  result.canceledCount
 *
 * @apiSuccessExample {json} Response example
 * {
 *   "result": {
 ...
 * @apiParam {Array}   [menus]            Provided if changed
 *
 * @apiExample {json} Request example
 * {
 *   "bookingId": "gJQu5XT931",
...
/**
 * @api {post} /rechargeBooking rechargeBooking
 * @apiVersion 1.0.0
 * @apiName rechargeBooking
 * @apiGroup Web-Booking
 * @apiPermission Login Required as Salon operator
 *
 * @apiDescription Recharge Booking
 *
 * @apiParam {String}  bookingId
 *
 * @apiExample {json} Request example
