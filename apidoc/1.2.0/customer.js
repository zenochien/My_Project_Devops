/**
 * @api {post} /requestDeleteCustomer requestDeleteCustomer
 * @apiVersion 1.2.0
 * @apiName requestDeleteCustomer
 * @apiGroup Customer
 * @apiPermission Login Required as Customer
 * @apiDescription request delete Customer
 *
...
/**
 * @api {post} /revokeDeleteCustomerAccountRequest revokeDeleteCustomerAccountRequest
 * @apiVersion 1.2.0
 * @apiName revokeDeleteCustomerAccountRequest
 * @apiGroup Customer
 * @apiPermission Login Required as Customer
 * @apiDescription revoke deleting account request
 *
 * @apiParam {String} password
 *
 * @apiExample {json} Request example
 ...
 * @apiUse ObjectNotFoundError
 */
function revokeDeleteCustomerAccountRequest() {}

/**
 * @api {post} /deleteCustomer deleteCustomer
 * @apiVersion 1.2.0
...
/**
 * @api {post} /adminDeleteCustomer adminDeleteCustomer
 * @apiVersion 1.2.0
 * @apiName adminDeleteCustomer
 * @apiGroup Customer
